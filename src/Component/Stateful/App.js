...
class App extends React.Component {
    ...
    //choose the menu to display and handle the Menu Clicks
    ...
    //handle the Click Operations in the App for the Displays
    tap = (menu, screen) => {
    ...
    //handle the Rotation Operations in the App for the Options
    rotate = (menu) => {
    ...
    componentDidMount() {
        ...
        this.activeRegionOuter = new ZingTouch.Region(
            this.containerElementOuter
        );
    }

    //called when we press the Play/Pause Button to Play-Pause the Song
    play = (songsList) => {
        if (
